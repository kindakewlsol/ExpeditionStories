...
using ExpeditionStories.Views.Menu;
using ExpeditionStories.Views.Users;
using System;
...
namespace ExpeditionStories.ViewModels.Users
{
    public class LoginViewModel : BaseViewModel
    {
        ...
        {
            get { return new Command(() => { OnSignupCommand(); }); }
        }
        ...
        {
            get { return new Command(() => { OnForgotPasswordCommand(); }); }
        }
        ...
        {
            App.Current.MainPage = (new MDetailPage());
        }
